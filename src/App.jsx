    ...
    <div className={style.container}>
      ...
      <div className={style.header_content} id="home">
        <div className={style.btn_container}>
          ...
          <a href="#radio">
            <button className={style.mainBtn}>Radios</button>
          </a>
          <a href="#switch">
          ...
          <a href="#ho">
            <button className={style.mainBtn}>Home Office</button>
          </a>
        </div>
      </div>
      ...
      <div className={style.box_container}>
                  ...
                  <tr>
                    ...
                    <td>
                      <span className={style.tooltip}>
                        ...
                        {radio.status === "N/A" && <span className={style.tooltiptext}>Informação não encontrada</span>}
                      </span>
                    </td>
                    <td>
        ...
        <div className={style.box_content}>
          <div className={style.header_box_content}>
            ...
            <label>
              <i className="fa-solid fa-magnifying-glass"></i>
              <input className={style.searchbar} placeholder="Pesquise o Switch" value={querySWITCH} onChange={handleSearchChangeSWITCH} />
            </label>
          </div>
                  ...
                  <tr id={style.swicth_id}>
                    ...
                    <td>
                      <span className={style.tooltip}>
                        ...
                        {swicth.status === "N/A" && <span className={style.tooltiptext}>Informação não encontrada</span>}
                      </span>
                    </td>
                    <td>
                ...
                <tbody>
                  <tr>
                    ...
                    <td>
                      <span className={style.tooltip}>
                        <span>
                          {conversor.status === "Em Linha" && <span className={style.status_emlinha}>{conversor.status}</span>}
                        ...
                        {conversor.status === "Suporte" && <span className={style.tooltiptext}>Ainda fornecemos suporte</span>}
                        {conversor.status === "N/A" && <span className={style.tooltiptext}>Informação não encontrada</span>}
                      </span>
                    </td>
                    <td>
                ...
                return (
                  <tbody>
                    <tr>
                      ...
                      <td>
                        <span className={onu.modulação === "Fast" ? style.fast : style.gigabit}>{onu.modulação}</span>
                      </td>
                      <td>{onu.fxs}</td>
                      <td>
                        {onu.tipo === "EPON/GPON" && <span className={style.variado1}>{onu.tipo}</span>}
                        {onu.tipo === "GPON" && <span className={style.fast}>{onu.tipo}</span>}
                      </td>
                      <td>{onu.transmissao2ghz}</td>
                      <td>{onu.transmissao5ghz}</td>
                      <td>{onu.clientesSimultaneos}</td>
                      <td>{onu.ssid}</td>
                      <td>{onu.tr069}</td>
                      <td>{onu.customize}</td>
                      <td>{onu.remotize}</td>
                      ...
                      <td>
                        <span className={style.tooltip}>
                          ...
                          {onu.status === "N/A" && <span className={style.tooltiptext}>Informação não encontrada</span>}
                        </span>
                      </td>
                      <td>
