      ...
      <div className={style.box_container}>
        ...
        <div className={style.box_content}>
          <div className={style.header_box_content}>
            <h2 id="ap">
              Access Point
              <button className={HideAP ? style.btnHide : style.btnShow} onClick={handleHideAP}></button>
            </h2>
            <label>
                  ...
                  return (
                    <tbody>
                      <tr>
                        ...
                        <td className={ap.throughputWireless50 === "" ? style.colorRed : null}>{ap.throughputWireless50}</td>
                        <td>{ap.qtdePortas}</td>
                        <td className={ap.poe === "" && style.colorRed}>{ap.poe}</td>
                        <td>{ap.handover}</td>
                        <td>{ap.wisefi}</td>
        ...
        <div className={style.box_content}>
          <div className={style.header_box_content}>
            <h2 id="radio">
              Radios Outdoor
              <button className={HideRADIO ? style.btnHide : style.btnShow} onClick={handleHideRADIO}></button>
            </h2>
            <label>
              <i className="fa-solid fa-magnifying-glass"></i>
              <input
        ...
        <div className={style.box_content}>
          <div className={style.header_box_content}>
            <h2 id="ho">
              Roteadores HO
              <button className={HideHO ? style.btnHide : style.btnShow} onClick={handleHideHO}></button>
            </h2>
            <label>
              <i className="fa-solid fa-magnifying-glass"></i>
              <input placeholder="Pesquise o Equipamento" value={queryHO} onChange={handleSearchChangeHO} className={style.searchbar} />
            </label>
          </div>
          {HideHO ? (
            <div style={{overflowX: "auto"}}>
        ...
        <div className={style.box_content}>
          <div className={style.header_box_content}>
            <h2 id="switch">
              Switchs
              <button className={HideSwitch ? style.btnHide : style.btnShow} onClick={handleHideSwitch}></button>
            </h2>
            <label>
              <i className="fa-solid fa-magnifying-glass"></i>
              <input
        ...
        <div className={style.box_content}>
          <div className={style.header_box_content}>
            <h2 id="conversor">
              Conversor de Mídia
              <button className={HideConversor ? style.btnHide : style.btnShow} onClick={handleHideConversor}></button>
            </h2>
          </div>
          {HideConversor ? (
            <table className={style.devicesTable}>
                ...
                return (
                  <tbody>
                    <tr>
                      ...
                      <td>
                        <span className={conversor.modulação === "Fast" ? style.fast : style.gigabit}>{conversor.modulação}</span>
                      </td>
        ...
        <div className={style.box_content}>
          <div className={style.header_box_content}>
            <h2 id="gbic">
              Módulo SFP
              <button className={HideSFP ? style.btnHide : style.btnShow} onClick={handleHideSFP}></button>
            </h2>
          </div>
          {HideSFP ? (
            <table className={style.devicesTable}>
        ...
        <div className={style.box_content}>
          <div className={style.header_box_content}>
            <h2 id="onu">
              ONUs/ONTs
              <button className={HideONU ? style.btnHide : style.btnShow} onClick={handleHideONU}></button>
            </h2>
          </div>
          {HideONU ? (
            <table className={style.devicesTable}>
                  ...
                  return (
                    <tbody>
                      <tr>
                        ...
                        <td>{onu.modulação}</td>
                        <td className={onu.fxs === "" ? style.colorRed : null}>{onu.fxs}</td>
                        <td>
                          {onu.tipo === "EPON/GPON" && <span className={style.variado1}>{onu.tipo}</span>}
                          {onu.tipo === "GPON" && <span className={style.variado2}>{onu.tipo}</span>}
                        </td>

                        <td className={onu.transmissao2ghz === "" ? style.colorRed : null}>{onu.transmissao2ghz}</td>
                        <td className={onu.transmissao5ghz === "" ? style.colorRed : null}>{onu.transmissao5ghz}</td>
                        <td className={onu.ssid === "" ? style.colorRed : null}>{onu.ssid}</td>
                        <td>{onu.tr069}</td>
                        <td>{onu.customize}</td>
                        <td>{onu.remotize}</td>
                        <td>{onu.garantia}</td>
