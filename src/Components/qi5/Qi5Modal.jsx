...
function Qi5Modal({ addDevice, updateDevice, updatedProduct, setUpdatedProduct, closeModal, modalIsOpen }) {
    ...
    >
      <form onSubmit={handleSubmit}>
        ...
        <OlimpoTextInput
          label="URL da Página"
          type="text"
          placeholder="https://www.intelbras.com/pt-br/roteador-5g-gx-3000"
